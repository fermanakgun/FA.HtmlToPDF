...
namespace FA.HtmlToPDF.Models
{
    ...
    {
        /// <summary>Page width in PDF points. Default: 595 (A4).</summary>
        ...
        /// <summary>Top margin in PDF points. Default: 20.</summary>
        public float MarginTop { get; set; } = 20f;

        /// <summary>Bottom margin in PDF points. Default: 20.</summary>
        public float MarginBottom { get; set; } = 20f;

        /// <summary>Left margin in PDF points. Default: 20.</summary>
        public float MarginLeft { get; set; } = 20f;

        /// <summary>Right margin in PDF points. Default: 20.</summary>
